...
public class Items {
    ...
    public static void onModelRegistry(ModelRegistryEvent event) {
        for (int capacity : ItemVolumetricFlask.CAPACITIES) {
            ModelLoader.setCustomModelResourceLocation(VOLUMETRIC_FLASK, capacity, new ModelResourceLocation(VOLUMETRIC_FLASK.getRegistryName(), "inventory"));
        }
